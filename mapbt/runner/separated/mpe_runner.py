...
from mapbt.runner.separated.base_runner import Runner
import imageio
            ...
            if episode % self.log_interval == 0:
                ...
                if self.env_name == "MPE":
                    for agent_id in range(self.num_agents):
                        ...
                        print("agent_id #", agent_id, f"average episode rewards is {np.mean(self.buffer[agent_id].rewards) * self.episode_length}")
