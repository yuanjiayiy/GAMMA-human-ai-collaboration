...
from mapbt.utils.shared_buffer import SharedReplayBuffer
...
def make_trainer_policy_cls(algorithm_name, use_single_network=False):
    if "mappo" in algorithm_name:
        if use_single_network:
            from mapbt.algorithms.r_mappo_single.r_mappo_single import R_MAPPO as TrainAlgo
            from mapbt.algorithms.r_mappo_single.algorithm.rMAPPOPolicy import R_MAPPOPolicy as Policy
        else:
            from mapbt.algorithms.r_mappo.r_mappo import R_MAPPO as TrainAlgo
            from mapbt.algorithms.r_mappo.algorithm.rMAPPOPolicy import R_MAPPOPolicy as Policy
    elif "mappg" in algorithm_name:
        if use_single_network:
            from mapbt.algorithms.r_mappg_single.r_mappg_single import R_MAPPG as TrainAlgo
            from mapbt.algorithms.r_mappg_single.algorithm.rMAPPGPolicy import R_MAPPGPolicy as Policy
        else:
            from mapbt.algorithms.r_mappg.r_mappg import R_MAPPG as TrainAlgo
            from mapbt.algorithms.r_mappg.algorithm.rMAPPGPolicy import R_MAPPGPolicy as Policy
    elif "bc" == algorithm_name:
        from mapbt.algorithms.bc.bc import BC_Trainer as TrainAlgo
        from mapbt.algorithms.bc.algorithm.BCPolicy import BCPolicy as Policy
    elif "ft" in algorithm_name:
        print("use frontier-based algorithm")
    elif "population" == algorithm_name:
        from mapbt.algorithms.population.trainer_pool import TrainerPool as TrainAlgo
        ...
        from mapbt.algorithms.population.mep import MEP_Trainer as TrainAlgo
        from mapbt.algorithms.population.policy_pool import PolicyPool as Policy
    elif algorithm_name == "traj":
        from mapbt.algorithms.population.traj import Traj_Trainer as TrainAlgo
        from mapbt.algorithms.population.policy_pool import PolicyPool as Policy
    elif algorithm_name == "lipo":
        from mapbt.algorithms.population.lipo import LIPO_Trainer as TrainAlgo
        from mapbt.algorithms.population.policy_pool import PolicyPool as Policy
    else:
