...
def parse_args(args, parser):
    ...
    parser.add_argument("--trainer_reward_shaping_command", type=str, default="")
...
def main(args):
    ...
    if all_args.use_wandb:
        assert False, "to render, disable wand logging"
    else:
        if not run_dir.exists():
            curr_run = 'run1'
        else:
    ...
    if all_args.share_policy:
        from mapbt.runner.shared._dev_runner import OvercookedRunner as Runner
    else:
        raise NotImplementedError
