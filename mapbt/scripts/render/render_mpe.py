...
from mapbt.envs.mpe.MPE_env import MPEEnv
from mapbt.envs.env_wrappers import SubprocVecEnv, DummyVecEnv
...
def main(args):
    ...
    if all_args.share_policy:
        from mapbt.runner.shared.mpe_runner import MPERunner as Runner
    else:
        from mapbt.runner.separated.mpe_runner import MPERunner as Runner
