...
def main(args):
    ...
    outcome_info = runner.evaluate_with_multi_policy()
    print()
    print("agent_0 reward:", outcome_info[f"{all_args.agent0_policy_name}-{all_args.agent1_policy_name}-eval_ep_sparse_r_by_agent0"])
    print("agent_1 reward:", outcome_info[f"{all_args.agent0_policy_name}-{all_args.agent1_policy_name}-eval_ep_sparse_r_by_agent1"])
    print("sum reward:", outcome_info[f"{all_args.agent0_policy_name}-{all_args.agent1_policy_name}-eval_ep_sparse_r"])
