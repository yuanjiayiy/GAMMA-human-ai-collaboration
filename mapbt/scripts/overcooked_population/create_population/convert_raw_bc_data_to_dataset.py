...
def parse_args(args, parser):
    ...
    parser.add_argument("--raw_training_data", default="data.pkl", type=str, help="pickle file for human-human training data")
    parser.add_argument("--raw_test_data", default="data.pkl", type=str, help="pickle file for human-human test data")
...
def main(args):
    ...
    if all_args.use_wandb:
        run = wandb.init(config=all_args,
                         ...
                         dir=str(run_dir),
                         job_type=str(all_args.experiment_name) + "_training",
                         reinit=True,
    ...
    if all_args.share_policy:
        from mapbt.scripts.overcooked_population.create_population.shared_runner import OvercookedRunner as Runner
    else:
        raise NotImplementedError
