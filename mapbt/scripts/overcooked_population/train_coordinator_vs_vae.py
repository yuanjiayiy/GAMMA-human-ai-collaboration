...
def parse_args(args, parser):
    ...
    parser.add_argument("--vae_z_generator", type=str, default="normal_gaussian", choices=["normal_gussian", "human_biased", "human_biased_std"], help="the type of the z generator")
...
def main(args):
    ...
    if all_args.use_wandb:
        run = wandb.init(config=all_args,
                         ...
                         group="coordinator_"+all_args.layout_name,
                         dir=str(run_dir),
                         job_type=str(all_args.experiment_name),
                         reinit=True,
    ...
    if all_args.share_policy:
        from mapbt.scripts.overcooked_population.coordinator.shared_runner import OvercookedRunner as Runner
    else:
        raise NotImplementedError
    ...
    runner.train_coordinator_vs_vae()
