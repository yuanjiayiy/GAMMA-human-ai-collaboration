...
vae_model_dir=${path}/pop_data/${pop}/vae_models/fft_kl_from_${AA}_to_${BB}
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$4 python overcooked_population/train_coordinator_vs_vae.py \
        ...
        --stage 2 --save_interval 100 --log_interval 10 \
        --old_dynamics \
