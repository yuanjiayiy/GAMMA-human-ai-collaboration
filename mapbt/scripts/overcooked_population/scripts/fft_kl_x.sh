...
layout=$1 # diverse_counter_circuit_6x5 # asymmetric_advantages diverse_counter_circuit_6x5
kl=$2
...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$3 python overcooked_population/train_vae.py --env_name ${env} --algorithm_name ${algo} --experiment_name ${exp} --layout_name ${layout} --num_agents ${num_agents} \
        ...
        --vae_chunk_length 100 --vae_epoch 1000 --vae_batch_size 64 --vae_init_kl_penalty 0.01 --vae_kl_penalty 2.0 \
        ...
        --vae_model_dir ${path}/pop_data/${pop}/vae_models/best_logp_kl_${kl}
done
