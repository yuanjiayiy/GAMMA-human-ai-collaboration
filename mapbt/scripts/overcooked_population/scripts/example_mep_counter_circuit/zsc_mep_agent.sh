...
do
    echo "seed is ${seed}:"
    CUDA_VISIBLE_DEVICES=$1 python overcooked_population/train_coordinator_vs_agents.py \
        ...
        --use_eval --n_eval_rollout_threads 32 --eval_interval 25 --eval_episodes 32 --eval_stochastic --use_evaluation_agents --eval_on_old_dynamics \
        --save_interval 25 \
