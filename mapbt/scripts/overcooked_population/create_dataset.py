...
def parse_args(args, parser):
    ...
    parser.add_argument("--total_trajectories", default=1000, type=int, help="total number of joint trajectories to collect")
    parser.add_argument("--test_trajectories", default=1000, type=int, help="test trajectories from heldout agents")
