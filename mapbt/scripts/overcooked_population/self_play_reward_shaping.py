...
def parse_args(args, parser):
    ...
    parser.add_argument("--trainer_reward_shaping_command", default="", type=str)
    parser.add_argument("--trainer_reward_shaping_annealing", default="const", choices=["const", "linear", "cos_2cycle", "sin_2cycle"])
