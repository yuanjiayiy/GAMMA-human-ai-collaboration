...
def main(args):
    ...
    inputs, targets = human_data["ep_states"], human_data["ep_actions"]
    inputs, targets = np.vstack(inputs), np.vstack(targets)
    runner.trainer.load_data(inputs, targets)
    runner.behavior_cloning(human_data)
